...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>$.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>$.jsxs("div",{className:"CommentInfo",children:[$.jsx("p",{className:"CommentInfo__name",children:e.name}),$.jsx("a",{href:`mailto:${e.email}`,className:"CommentInfo__email",children:e.email}),$.jsx("p",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>e.map(t=>$.jsx(Lc,{comment:t},t.key)),Mc=({post:e})=>$.jsxs("div",{className:"PostInfo",children:[$.jsxs("div",{className:"PostInfo__header",children:[$.jsx("h3",{className:"PostInfo__title",children:e.title}),$.jsxs("p",{children:["Posted by",$.jsx(Pc,{user:e.user})]})]}),$.jsx("p",{className:"PostInfo__body",children:e.body}),$.jsx("hr",{}),e.comments.length?$.jsx(Tc,{comments:e.comments}):$.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=({posts:e})=>$.jsx("div",{className:"PostList",children:e.map(t=>$.jsx(Mc,{post:t}))});function Dc(e){return Nc.find(t=>t.id===e)||null}function jc(e){return zc.filter(t=>t.post.id===e)}const Oc=Cc.map(e=>({user:Dc(e.userId),comments:jc(e.postId)})),Fc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render($.jsx(Fc,{}));
